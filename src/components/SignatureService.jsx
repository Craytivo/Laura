...
export function SignatureService({image,service,business,onBook}){
 return <section className="signature" data-reveal><div className="signature-image"><ResponsiveImage image={image} className="real-image signature-photo" loading="lazy" sizes="(max-width: 800px) 100vw, 50vw"/></div>
