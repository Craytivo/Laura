...
export function Hero({image,service,business,onBook,onNavigate}){
 ...
 </div><div className="hero-art"><div className="hero-art-index">01 <span>THE STUDIO</span></div><div className="hero-art-frame"><img className="real-image hero-photo" src={image.src} alt={image.alt} fetchPriority="high" loading="eager" decoding="async" sizes="(max-width: 800px) 100vw, 50vw"/><div className="hero-image-label">RU SUGARING · EDMONTON</div></div><div className="hero-art-note">PRIVATE / PERSONAL / EDMONTON</div></div>
 </section>;
}
