...
export const services: Service[] = [
  ...
  { id:"full-legs", name:"Full Legs", price:"$60", duration:"50 min", description:"Complete hair removal from the upper thighs to the ankles." },
  { id:"half-legs", name:"Half Legs", price:"$45", duration:"30 min", description:"Hair removal from the lower legs, from the knees to the ankles." },
  { id:"full-arms", name:"Full Arms", price:"$45", duration:"40 min", description:"Complete hair removal from the shoulders to the wrists." },
  { id:"half-arms", name:"Half Arms", price:"$35", duration:"35 min", description:"Hair removal from the lower arms, from the elbows to the wrists." },
  { id:"full-stomach", name:"Full Stomach", price:"$20", duration:"30 min", description:"Complete hair removal from the stomach area." },
